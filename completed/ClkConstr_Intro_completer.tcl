...
set_property target_constrs_file C:/training/$tcName/$demoOrLab/$platform/$language/$projName.srcs/constrs_1/imports/$language/wave_gen_timing.xdc [current_fileset -constrset]
