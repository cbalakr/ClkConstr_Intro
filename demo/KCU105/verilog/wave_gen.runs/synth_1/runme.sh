...
HD_PWD='C:/2018.1/S.P/training/ClkConstr_Intro/demo/KCU105/verilog/wave_gen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wave_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wave_gen.tcl
